public class dayOfTheProgrammer {
    ...
    public static String dayOfProgrammer(int year) {
        /*
            transition from the Julian to Gregorian calendar system occurred in 1918 so
            ts 256th day will land on Sep. 26th
        */
        if (year == 1918) {
            return "26.09.1918";
        }
    ...
    private static boolean isLeapYear(int year) {
        ...
        /*
            any year under 1918 is a leap year as per Julian calendar, leap years are either divisible by 400 or
            divisible by 4 and not divisible by 100
         */
